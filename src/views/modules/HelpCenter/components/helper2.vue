  ...
  <div class="mx-auto px-20 py-6 space-y-8">
    <template v-if="$i18n.locale === 'en'">
      ...
      <div class="space-y-6 text-gray-700 text-lg leading-relaxed">
        ...
        <p class="text-6xl leading-snug">2. The shared link is only for accessing Shengle products.</p>
    ...
    <template v-else-if="$i18n.locale === 'zh-CN'">
      ...
      <div class="space-y-6 text-gray-700 text-lg leading-relaxed">
        ...
        <p class="text-6xl leading-snug">2. 分享的链接仅用于访问盛乐产品。</p>
    ...
    <template v-else-if="$i18n.locale === 'zh-TW'">
      ...
      <div class="space-y-6 text-gray-700 text-lg leading-relaxed">
        ...
        <p class="text-6xl leading-snug">2. 分享的鏈接僅用於訪問盛乐產品。</p>
